						...
						<div <?php post_class('single tops clear'); ?> id="post_<?php the_ID(); ?>">
							...
							<div class="rside">
								<div class="post-meta">
									...
									Type : <?php echo get_post_meta($post->ID, 'type_file', true); ?>, <a
										href="<?php echo get_post_meta($post->ID, 'podcast_file', true); ?>">Download</a>
									<em>(<?php echo get_post_meta($post->ID, 'size_file', true); ?>)</em>
								</div>
							</div>
