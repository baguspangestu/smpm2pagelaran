						...
						<div <?php post_class('single tops clear'); ?> id="post_<?php the_ID(); ?>">
							...
							<div class="rside">
								<div class="post-meta">
									...
									<?php printf(
										__('Diterbitkan : <span class="post-date">%s</span>, Penulis : <span class="post-date">%s</span>', 'mading'),
						...
						<div class="single sing clear">
							...
							<div class="rside">
								<div class="post-content">
									<?php if (has_post_thumbnail()) echo '<div class="edi-img">' . get_the_post_thumbnail(
										$post->ID,
										'photo',
										array(
